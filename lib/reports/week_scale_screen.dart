...
class WeekScaleScreen extends StatefulWidget {



  @override
  _WeekScaleScreenState createState() => _WeekScaleScreenState();
}

class _WeekScaleScreenState extends State<WeekScaleScreen> with  Helpers {
        ...
        body: ListView(
          ...
          children: [
            ...
            StreamBuilder<QuerySnapshot>(
              stream: FbFirestoreController().readScaleWeek(),
