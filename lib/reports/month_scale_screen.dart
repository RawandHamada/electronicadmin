...
class MonthScaleScreen extends StatefulWidget {



  @override
  _MonthScaleScreenState createState() => _MonthScaleScreenState();
}

class _MonthScaleScreenState extends State<MonthScaleScreen> with  Helpers {
        ...
        body: ListView(
          ...
          children: [
            ...
            StreamBuilder<QuerySnapshot>(
              stream: FbFirestoreController().readScaleMonth(),
